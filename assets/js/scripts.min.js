...
class RulesView extends View{constructor(){super();this.baseElement.classList.add("text-center");var a=View.createWhiteButton(this.baseElement,{imageId:Icon.Clear,text:Strings.Close},this.back.bind(this),"small");a.style.position="absolute";a.style.left=extraLargeMarginCss;a.style.top=extraLargeMarginCss;this.fadingRule=!1;this.currentRule=0;a=document.createElement("div");a.className="rule-container";var b=document.createElement("div");b.className="rule-prev fade";b.onclick=this.previousRule.bind(this);
this.previousRuleButton=b;a.appendChild(b);b=document.createElement("img");b.className="rule-image fade visible";b.src="assets/images/rule0.png";this.ruleImage=b;a.appendChild(b);b=document.createElement("div");b.className="rule-next fade visible";b.onclick=this.nextRule.bind(this);this.nextRuleButton=b;a.appendChild(b);this.baseElement.appendChild(a);a=document.createElement("div");a.className="result-label visible";b=Array(RulesView.TotalRuleCount);for(let c=0;c<RulesView.TotalRuleCount;c++){const d=
document.createElement("span");d.className=c?"marker":"marker done";a.appendChild(d);b[c]=d;const e=document.createElement("span");e.className="points";d.appendChild(e)}this.ruleMarker=b;b=document.createElement("div");b.className="row2";b.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';
a.appendChild(b);this.baseElement.appendChild(a)}async attach(){}async detach(){}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}async changeRule(a){if(!(View.fading||this.fadingRule||!this.ruleMarker||(a=this.currentRule+a,0>a||a>=RulesView.TotalRuleCount))){this.fadingRule=!0;0<a?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible");a<RulesView.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible");
this.ruleImage.classList.remove("visible");await delay(slowAnimationTimeoutMS);var b=this.ruleMarker;for(let c=0;c<RulesView.TotalRuleCount;c++)c<=a?b[c].classList.add("done"):b[c].classList.remove("done");this.ruleImage.src=`assets/images/rule${a}.png`;await delay(fastAnimationTimeoutMS);this.ruleImage.classList.add("visible");this.currentRule=a;await delay(slowAnimationTimeoutMS);this.fadingRule=!1}}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}RulesView.TotalRuleCount=5;
