...
this.installButton=View.createBlueButton(this.baseElement,Strings.Install,this.install.bind(this),"fade small");this.installButton.style.position="absolute";this.installButton.style.right=extraLargeMarginCss;this.installButton.style.bottom=extraLargeMarginRem+2+"rem";this.fullscreenButton=View.createWhiteButton(this.baseElement,Strings.Fullscreen,this.fullscreen.bind(this),"fade small");this.fullscreenButton.style.position="absolute";this.fullscreenButton.style.right=extraLargeMarginCss;this.fullscreenButton.style.bottom=
extraLargeMarginCss;this.fadeSequence=0;this.fadeElements=null;this.fadeInterval=0;this.boundInstallationPromptHandler=this.installationPromptHandler.bind(this);this.installationPromptHandler()}async attach(){installationPromptHandler=this.boundInstallationPromptHandler;musicButton=this.musicButton;updateMusicButton()}async detach(){musicButton=installationPromptHandler=null;this.fadeInterval&&(clearInterval(this.fadeInterval),this.fadeInterval=0)}destroyInternal(a){}fadeInFinished(){this.startFadeSequence(1)}startFadeSequence(a,
b){if(!this.fadeSequence){var c=[this.logo,this.subtitle,this.startButton,this.rulesButton,this.creditsButton,this.musicButton,this.installButton,this.fullscreenButton];0>a&&c.reverse();this.fadeSequence=a;this.fadeElements=c;this.fadeInterval=window.setInterval(()=>{var d=Math.abs(this.fadeSequence)-1;!this.fadeElements||d>=this.fadeElements.length?(clearInterval(this.fadeInterval),this.fadeSequence=0,this.fadeElements=null,this.fadeInterval=0,b&&b()):(d=this.fadeElements[d],0<this.fadeSequence?
...
fullscreenChanged;Promise.all([async function(){bgMusic=document.createElement("audio");bgMusic.loop=!0;bgMusic.src="assets/sounds/bgfade.mp3";document.body.appendChild(bgMusic);bgMusic.load()}(),Alien.preloadAllImages()]).then(a,a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
