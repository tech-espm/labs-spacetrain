...
document.createElement("div");this.textProtection.className="text-protection"}async attach(){document.body.insertBefore(this.textProtection,document.body.firstChild)}async detach(){document.body.removeChild(this.textProtection)}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
...
this.previousRuleButton=a;b.appendChild(a);a=document.createElement("div");a.className="rule-image";a.style.background="none";this.ruleImageContainer=a;b.appendChild(a);var c=document.createElement("div");c.className="rule-next fade visible";c.onclick=this.nextRule.bind(this);this.nextRuleButton=c;b.appendChild(c);this.baseElement.appendChild(b);b=document.createElement("div");b.className="result-label visible";c=Array(RulesView.TotalRuleCount);const d=Array(RulesView.TotalRuleCount);for(let f=0;f<
RulesView.TotalRuleCount;f++){var e=document.createElement("img");e.className=f?"rule-image fade":"rule-image fade visible";e.src=`assets/images/rule${f}.png`;c[f]=e;e=document.createElement("span");e.className=f?"marker":"marker done";b.appendChild(e);d[f]=e;const g=document.createElement("span");g.className="points";e.appendChild(g)}this.ruleImage=c;this.ruleMarker=d;a.appendChild(c[0]);a=document.createElement("div");a.className="row2";a.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';
b.appendChild(a);this.baseElement.appendChild(b)}async attach(){}async detach(){}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}async changeRule(a){if(!(View.fading||this.fadingRule||!this.ruleMarker||(a=this.currentRule+a,0>a||a>=RulesView.TotalRuleCount))){this.fadingRule=!0;0<a?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible");a<RulesView.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible");
this.ruleImage[this.currentRule].classList.remove("visible");await delay(slowAnimationTimeoutMS);var b=this.ruleMarker;for(let c=0;c<RulesView.TotalRuleCount;c++)c<=a?b[c].classList.add("done"):b[c].classList.remove("done");this.ruleImageContainer.removeChild(this.ruleImage[this.currentRule]);this.ruleImageContainer.appendChild(this.ruleImage[a]);await delay(animationStartDelayMS);this.ruleImage[a].classList.add("visible");this.currentRule=a;await delay(slowAnimationTimeoutMS);this.fadingRule=!1}}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}
RulesView.TotalRuleCount=5;
...
View.createWhiteButton(this.baseElement,Strings.Fullscreen,this.fullscreen.bind(this),"fade small");this.fullscreenButton.style.position="absolute";this.fullscreenButton.style.right=extraLargeMarginCss;this.fullscreenButton.style.bottom=extraLargeMarginCss;this.fadeSequence=0;this.fadeElements=null;this.fadeInterval=0}async attach(){musicButton=this.musicButton;updateMusicButton()}async detach(){musicButton=null;this.fadeInterval&&(clearInterval(this.fadeInterval),this.fadeInterval=0)}destroyInternal(a){}fadeInFinished(){this.startFadeSequence(1)}startFadeSequence(a,
b){if(!this.fadeSequence){var c=[this.logo,this.subtitle,this.startButton,this.rulesButton,this.creditsButton,this.musicButton,this.fullscreenButton];0>a&&c.reverse();this.fadeSequence=a;this.fadeElements=c;this.fadeInterval=window.setInterval(()=>{var d=Math.abs(this.fadeSequence)-1;!this.fadeElements||d>=this.fadeElements.length?(clearInterval(this.fadeInterval),this.fadeSequence=0,this.fadeElements=null,this.fadeInterval=0,b&&b()):(d=this.fadeElements[d],0<this.fadeSequence?(d.classList.add("visible"),
...
let scaleFactor=-1,widthCss=0,heightCss=0,baseLeftCss=0,baseTopCss=0,fontSize=0,fontSizeCss="0px",musicPlaying=!1,audioContext=null,audioBuffer=null,audioBufferSource=null,bgMusic=null,musicButton=null,installationPrompt=null,landscapeWarning=null;function ignorePromise(a){try{const b=()=>{};a&&a.then&&a.then(b,b)}catch(b){}}function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),"preventDefault"in a&&a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}
...
function setup(){function a(){View.loading=!1;bgMusic&&(bgMusic.onplay=function(){musicPlaying=!0;updateMusicButton()},bgMusic.onpause=function(){musicPlaying=!1;updateMusicButton()});View.createInitialView()}Strings.init();View.loading=!0;"serviceWorker"in navigator&&window.addEventListener("beforeinstallprompt",beforeInstallPrompt);window.onpopstate=View.windowHistoryStatePopped;window.onresize=adjustWindowSize;adjustWindowSize();FullscreenControl.onfullscreenchange=fullscreenChanged;Promise.all([async function(){bgMusic=
document.createElement("audio");bgMusic.loop=!0;bgMusic.src="assets/sounds/bgfade.mp3";document.body.appendChild(bgMusic);bgMusic.load()}(),Alien.preloadAllImages()]).then(a,a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
