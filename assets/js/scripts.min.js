...
this.ruleImage.classList.remove("visible");await delay(slowAnimationTimeoutMS);var b=this.ruleMarker;for(let c=0;c<RulesView.TotalRuleCount;c++)c<=a?b[c].classList.add("done"):b[c].classList.remove("done");this.ruleImage.src=`assets/images/rule${a}.png`;this.ruleImage.classList.add("visible");this.currentRule=a;await delay(slowAnimationTimeoutMS);this.fadingRule=!1}}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}RulesView.TotalRuleCount=5;
