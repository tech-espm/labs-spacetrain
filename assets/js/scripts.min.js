...
d.src=`assets/images/rule${c}.png`;b[c]=d}this.ruleImage=b;a.appendChild(b[0])}async attach(){}async detach(){}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}async changeRule(a){View.fading||this.fadingRule||!this.ruleImage||(a=this.currentRule+a,0>a||a>=RulesView.TotalRuleCount||(this.fadingRule=!0,0<a?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible"),a<RulesView.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible"),
this.ruleImage[this.currentRule].classList.remove("visible"),await delay(slowAnimationTimeoutMS),this.ruleImageContainer.removeChild(this.ruleImage[this.currentRule]),this.ruleImageContainer.appendChild(this.ruleImage[a]),await delay(animationStartDelayMS),this.ruleImage[a].classList.add("visible"),this.currentRule=a,await delay(slowAnimationTimeoutMS),this.fadingRule=!1))}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}RulesView.TotalRuleCount=5;
