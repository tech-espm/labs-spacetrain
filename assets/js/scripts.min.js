...
"Rodada ",Strings.point="ponto",Strings.points="pontos",Strings.Install="Instalar!",Strings.About="Sobre",Strings.PlayMusic="Tocar m\u00fasica",Strings.StopMusic="Parar m\u00fasica",Strings.Fullscreen="Tela Cheia",Strings.START="INICIAR",Strings.RULES="REGRAS",Strings.CREDITS="CR\u00c9DITOS",Strings.DecimalSeparator=",",Strings.OppositeDecimalSeparator=".",Strings.Success="Sucesso!",Strings.Pause="Pausa",Strings.Restart="Reiniciar",Strings.Time="Tempo",Strings.Name="Nome")}}
Strings.LandscapeWarning="The game works better in landscape mode :)";Strings.OK="OK";Strings.Cancel="Cancel";Strings.Clear="Clear";Strings.Close="Close";Strings.Exit="Exit";Strings.Play="Play";Strings.Menu="Menu";Strings.Edit="Edit";Strings.Delete="Delete";Strings.NextRound="Next Round";Strings.Finish="Finish!";Strings.of="of";Strings.Round="Round ";Strings.Total="Total: ";Strings.point="point";Strings.points="points";Strings.Install="Install!";Strings.Oops="Oops\u2026";Strings.Download="Download";
Strings.About="About";Strings.PlayMusic="Play music";Strings.StopMusic="Stop music";Strings.Fullscreen="Fullscreen";Strings.START="START";Strings.RULES="RULES";Strings.CREDITS="CREDITS";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Success="Success!";Strings.Pause="Pause";Strings.Restart="Restart";Strings.Time="Time";Strings.Name="Name";
...
1020,slowAnimationTimeoutMS=520,fastAnimationTimeoutMS=320,fastestAnimationTimeoutMS=120,blinkLastCounter=7,blinkSingleDurationMS=75,blinkTotalDurationMS=(blinkLastCounter+1)*blinkSingleDurationMS,baseWidth=1280,baseHeight=720,alienWidthRem=3.361930295,alienHeightRem=3.361930295,alienWidthCss=alienWidthRem+"rem",alienHeightCss=alienHeightRem+"rem",baseFontSize=32,baseHeightFontUnits=baseHeight/baseFontSize|0,iconSize=32;
...
class GameView extends View{constructor(){super();this.baseElement.classList.add("text-center");var a=View.createWhiteButton(this.baseElement,{imageId:Icon.Clear,text:Strings.Close},this.back.bind(this),"small");a.style.position="absolute";a.style.left=smallMarginCss;a.style.top=smallMarginCss;a=View.createBlueButton(this.baseElement,{imageId:Icon.Accept,text:Strings.NextRound},this.nextRound.bind(this),"small fade visible");a.setAttribute("disabled","disabled");a.style.position="absolute";a.style.right=
smallMarginCss;a.style.top=smallMarginCss;this.nextRoundButton=a;a=document.createElement("div");a.style.pointerEvents="none";a.style.marginTop=alienHeightCss;a.style.height=alienHeightCss;this.shelf=a;this.baseElement.appendChild(a);a=document.createElement("div");a.className="train";this.alienRow=a;for(var b=GameView.MaximumAlienCount-1;0<=b;b--){var c=document.createElement("div");c.className="target";a.appendChild(c)}this.baseElement.appendChild(a);a=document.createElement("div");a.className=
"result-label";this.resultLabel=a;b=document.createElement("span");b.className="round";a.appendChild(b);this.resultLabelRound=b;b=Array(GameView.TotalRoundCount);for(c=0;c<GameView.TotalRoundCount;c++){const d=document.createElement("span");d.className="marker";a.appendChild(d);b[c]=d;const e=document.createElement("span");e.className="points";d.appendChild(e)}this.resultLabelMarker=b;b=document.createElement("span");b.className="total";a.appendChild(b);this.resultLabelTotal=b;b=document.createElement("div");
b.className="row2";b.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';a.appendChild(b);this.baseElement.appendChild(a);this.musicButton=View.createWhiteButton(this.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small visible");this.musicButton.style.position=
"absolute";this.musicButton.style.fontSize="0.5rem";this.musicButton.style.left="1.5rem";this.musicButton.style.bottom="1.5rem";this.baseElement.appendChild(this.musicButton);this.alive=!0;this.animating=!1;this.lastTime=this.frameRequest=0;this.movingAlien=this.pointerHandler=null;this.lastPlacedAlien=this.points=this.round=this.movingInitialY=this.movingInitialX=0;this.originalAlienPlacement=-1;this.boundMouseDown=this.mouseDown.bind(this);this.boundMouseMove=this.mouseMove.bind(this);this.boundMouseUp=
this.mouseUp.bind(this);this.boundOutsidePointerHandler=this.outsidePointerHandler.bind(this);this.boundRender=this.render.bind(this)}async attach(){musicButton=this.musicButton;updateMusicButton();this.lastTime=performance.now();this.alive=!0;this.pointerHandler=new PointerHandler(this.baseElement,this.boundMouseDown,this.boundMouseMove,this.boundMouseUp,!1,this.boundOutsidePointerHandler)}async detach(){musicButton=null;this.alive=!1;this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=
null);this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0)}destroyInternal(a){a||Alien.destroyAll()}fadeInFinished(){this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.frameRequest=requestAnimationFrame(this.boundRender);this.restart()}back(a){this.fadeTo(()=>new TitleView);return!0}async displayAddedPoints(a){1<this.round&&this.round<=GameView.TotalRoundCount+1&&(this.resultLabelMarker[this.round-2].firstChild.textContent=a.toString());
if(a){var b=document.createElement("div");b.className="added-points";b.textContent=`+ ${a} ${Strings.points}!`;this.baseElement.appendChild(b);await delay(animationStartDelayMS);this.alive&&(b.classList.add("fading"),await delay(1500),this.alive&&this.baseElement.removeChild(b))}}async generateNewAliens(a){var b=GameView.MaximumAlienCount,c=this.shelf,d=c.getElementsByClassName("alien");if(d.length){b=0;const e=[],f=[];for(let g=d.length-1,k=0;0<=g;g--,k+=75){const h=Alien.fromElement(d[g]);h&&(h.paused||
(e.push(h.shrink(k)),b++),f.push(h))}this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),e.push(delay(slowAnimationTimeoutMS)));await Promise.all(e);if(!this.alive)return;for(d=f.length-1;0<=d;d--)f[d].destroy()}else if(this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),await delay(slowAnimationTimeoutMS),!this.alive))return;this.displayAddedPoints(a);a=Array(b);for(let e=b-1,f=0;0<=e;e--,f+=75)b=Alien.create(Alien.KindRandom,
c),a[e]=b.grow(f);for(c=GameView.TotalRoundCount;1<=c;c--)c>this.round?this.resultLabelMarker[c-1].classList.remove("done"):this.resultLabelMarker[c-1].classList.add("done"),c>=this.round&&(this.resultLabelMarker[c-1].firstChild.textContent="");this.resultLabelRound.textContent=Strings.Round+this.round;this.resultLabelTotal.textContent=Strings.Total+this.points;await delay(animationStartDelayMS);this.alive&&(this.resultLabel.classList.add("visible"),await Promise.all(a),this.alive&&(this.animating=
!1))}async restart(){if(this.alive&&!this.animating&&!this.movingAlien){this.nextRoundButton.setAttribute("disabled","disabled");this.nextRoundButton.replaceChild(document.createTextNode(Strings.NextRound),this.nextRoundButton.childNodes[1]);this.animating=!0;var a=this.baseElement.getElementsByClassName("alien"),b=[];for(let c=a.length-1,d=0;0<=c;c--,d+=75){const e=Alien.fromElement(a[c]);e&&!e.paused&&b.push(e.shrink(d))}await Promise.all(b);this.alive&&(Alien.destroyAll(),this.animating=!1,this.lastPlacedAlien=
this.points=this.round=0,this.originalAlienPlacement=-1,this.nextRound())}}async gameOver(a){alert(a);this.animating=!0;await delay(slowAnimationTimeoutMS);this.animating=!1;return this.restart()}async gameFinished(a){this.animating=!0;this.resultLabel.classList.remove("visible");await delay(fastAnimationTimeoutMS);this.alive&&(this.round++,await this.displayAddedPoints(a),this.alive&&(this.animating=!1,alert("Vit\u00f3ria! "+this.points+" pontos!"),this.restart()))}computeAddedPoints(){if(!this.alienRow)return 0;
const a=this.alienRow.getElementsByClassName("alien");let b=Alien.KindRandom,c=0,d=0;for(let f=a.length-1;0<=f;f--){var e=Alien.fromElement(a[f]);e&&(e=e.kind.id,b===e?c++:(d+=GameView.PointsPerSequence[c],c=1,b=e))}return d+GameView.PointsPerSequence[c]}computeExtraPoints(){if(!this.alienRow)return 0;const a=this.alienRow.getElementsByClassName("alien"),b=Array(Alien.KindCount);b.fill(0);let c=0;for(let d=a.length-1;0<=d;d--){const e=Alien.fromElement(a[d]);e&&!b[e.kind.id]++&&c++}return 3*c}nextRound(){if(!this.alive||
this.animating||this.movingAlien)return!1;let a=0;this.lastPlacedAlien&&(a=this.computeAddedPoints(),this.points+=a);if(this.lastPlacedAlien>=GameView.MaximumAlienCount){const b=this.computeExtraPoints();a+=b;this.points+=b;this.gameFinished(a);return!0}this.animating=!0;this.round++;this.nextRoundButton.setAttribute("disabled","disabled");this.generateNewAliens(a);return!0}mouseDown(a){if(!this.alive||this.animating)return!1;const b=a.clientX;a=a.clientY;const c=[this.shelf,this.alienRow];for(let e=
c.length-1;0<=e;e--){const f=c[e].getElementsByClassName("alien");var d=c[e].getBoundingClientRect();if(a>=d.top&&a<d.bottom&&f&&f.length)for(let g=f.length-1;0<=g;g--)if(d=f[g].getBoundingClientRect(),b>=d.left&&b<d.right&&(d=Alien.fromElement(f[g]))&&d.element&&!d.paused)return d.element.classList.add("moving"),this.alienRow.classList.add("dragging"),this.movingInitialX=b,this.movingInitialY=a,this.movingAlien=d,this.originalAlienPlacement=d.placement,!0}return!1}mouseMove(a){this.movingAlien&&
this.movingAlien.element&&(this.movingAlien.element.style.transform=`translate(${a.clientX-this.movingInitialX}px, ${a.clientY-this.movingInitialY}px)`)}mouseUp(a){const b=this.movingAlien;if(b&&b.element){this.movingAlien=null;var c=this.alienRow,d=c.children,e=a.clientX;a=a.clientY;c.classList.remove("dragging");b.element.classList.remove("moving");b.element.style.transform="";c=c.getBoundingClientRect();if(a>=c.top&&a<c.bottom)for(a=d.length-1;0<=a;a--){const f=d[a];if(!(!f.classList.contains("target")||
e<(c=f.getBoundingClientRect()).left||e>=c.right)){if(0<=this.originalAlienPlacement){this.originalAlienPlacement!==a&&this.gameOver("N\u00e3o \u00e9 permitido reposicionar os alien\u00edgenas!");break}if(this.lastPlacedAlien!==a){this.gameOver("Um novo alien\u00edgena deve estar sempre na primeira posi\u00e7\u00e3o dispon\u00edvel!");break}if(f.childNodes.length){this.gameOver("N\u00e3o \u00e9 permitido substituir um alien\u00edgina j\u00e1 posicionado!");break}b.paused=!0;b.element.style.visibility=
"hidden";Alien.create(b.kind,f,this.lastPlacedAlien).grow();this.lastPlacedAlien++;this.round<GameView.TotalRoundCount&&this.nextRoundButton.removeAttribute("disabled");this.lastPlacedAlien>=GameView.MaximumAlienCount&&(this.nextRoundButton.removeAttribute("disabled"),this.nextRoundButton.replaceChild(document.createTextNode(Strings.Finish),this.nextRoundButton.childNodes[1]))}}}}outsidePointerHandler(a){return a.target&&"target"===a.target.className&&a.target.childNodes.length?!0:!1}render(a){if(this.alive){this.frameRequest=
requestAnimationFrame(this.boundRender);var b=a-this.lastTime;this.lastTime=a;33<b&&(b=33);Alien.stepAll(b)}else this.frameRequest=0}}GameView.TotalRoundCount=5;GameView.MaximumAlienCount=8;GameView.PointsPerSequence=[0,1,3,6,10,15,21,28,36];
...
let fullscreenChangedTimeout=0;function fullscreenChanged(a){fullscreenChangedTimeout&&(clearTimeout(fullscreenChangedTimeout),fullscreenChangedTimeout=0);try{FullscreenControl.fullscreenMode?fullscreenChangedTimeout=setTimeout(fullscreenChangedHandler,150):fullscreenChangedHandler()}catch(b){}}
