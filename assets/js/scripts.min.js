...
class CreditsView extends View{constructor(){super();var a=View.createWhiteButton(this.baseElement,{imageId:Icon.Clear,text:Strings.Close},this.back.bind(this),"small");a.style.position="absolute";a.style.left=smallMarginCss;a.style.top=smallMarginCss;a=document.createElement("div");a.className="text-center";a.style.paddingLeft=smallMarginCss;a.style.paddingRight=smallMarginCss;a.style.paddingBottom=smallMarginCss;a.innerHTML=Strings.CreditsHTML;this.baseElement.appendChild(a);this.baseElement.style.backgroundColor=
"rgba(47,14,82,0.75)"}async attach(){}async detach(){}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
