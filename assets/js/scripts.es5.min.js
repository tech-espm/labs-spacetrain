...
document)return document.onwebkitfullscreenchange;if("onmozfullscreenchange"in document)return document.onmozfullscreenchange;if("onmsfullscreenchange"in document)return document.onmsfullscreenchange}catch(b){}return null},enumerable:!1,configurable:!0});Object.defineProperty(a,"onfullscreenchange",{set:function(b){try{"onfullscreenchange"in document&&(document.onfullscreenchange=b),"onwebkitfullscreenchange"in document&&(document.onwebkitfullscreenchange=b),"onmozfullscreenchange"in document&&(document.onmozfullscreenchange=
b),"onmsfullscreenchange"in document&&(document.onmsfullscreenchange=b)}catch(c){}},enumerable:!1,configurable:!0});a.toggleFullscreen=function(){a.fullscreenMode=!a.fullscreenMode};Object.defineProperty(a,"fullscreenMode",{get:function(){return!!a.fullscreenElement},set:function(b){b?a.requestFullscreen():a.exitFullscreen()},enumerable:!1,configurable:!0});return a}(),PointerHandler=function(){function a(b,c,d,e,g,f){void 0===c&&(c=null);void 0===d&&(d=null);void 0===e&&(e=null);void 0===g&&(g=!0);
void 0===f&&(f=null);this.documentTarget=document.documentElement||document.body;this.element=b;this.downCallback=c;this.moveCallback=d;this.upCallback=e;this.boundExtraTouchStart=null;"onpointerdown"in b?(this.documentDownEvent="pointerdown",this.documentMoveEvent="pointermove",this.documentUpEvent="pointerup",this.documentCancelEvent="pointercancel",this.boundDocumentDown=this.pointerDown.bind(this),this.boundDocumentUp=this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this),
...
"small");d.style.position="absolute";d.style.left=extraLargeMarginCss;d.style.top=extraLargeMarginCss;d=document.createElement("div");d.className="text-center";d.style.paddingLeft=smallMarginCss;d.style.paddingRight=smallMarginCss;d.style.paddingBottom=smallMarginCss;d.innerHTML=Strings.CreditsHTML;c.baseElement.appendChild(d);c.textProtection=document.createElement("div");c.textProtection.className="text-protection";return c}__extends(b,a);b.prototype.attach=function(){return __awaiter(this,void 0,
void 0,function(){return __generator(this,function(c){document.body.insertBefore(this.textProtection,document.body.firstChild);return[2]})})};b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){document.body.removeChild(this.textProtection);return[2]})})};b.prototype.destroyInternal=function(c){};b.prototype.back=function(c){this.fadeToPrevious();return!0};return b}(View),GameView=function(a){function b(){var c=a.call(this)||this;c.baseElement.classList.add("text-center");
var d=View.createWhiteButton(c.baseElement,{imageId:Icon.Clear,text:Strings.Close},c.back.bind(c),"small");d.style.position="absolute";d.style.left=extraLargeMarginCss;d.style.top=extraLargeMarginCss;d=View.createBlueButton(c.baseElement,{imageId:Icon.Accept,text:Strings.NextRound},c.nextRound.bind(c),"fade small visible");d.setAttribute("disabled","disabled");d.style.position="absolute";d.style.right=extraLargeMarginCss;d.style.top=extraLargeMarginCss;c.nextRoundButton=d;d=document.createElement("div");
d.style.pointerEvents="none";d.style.marginTop=alienHeightRem+extraLargeMarginRem+"rem";d.style.height=alienHeightCss;c.shelf=d;c.baseElement.appendChild(d);d=document.createElement("div");d.className="train";c.alienRow=d;for(var e=b.MaximumAlienCount-1;0<=e;e--){var g=document.createElement("div");g.className="target";d.appendChild(g)}c.baseElement.appendChild(d);d=document.createElement("div");d.className="result-label";c.resultLabel=d;e=document.createElement("span");e.className="round";d.appendChild(e);
c.resultLabelRound=e;g=Array(b.TotalRoundCount);for(e=0;e<b.TotalRoundCount;e++){var f=document.createElement("span");f.className="marker";d.appendChild(f);g[e]=f;var h=document.createElement("span");h.className="points";f.appendChild(h)}c.resultLabelMarker=g;e=document.createElement("span");e.className="total";d.appendChild(e);c.resultLabelTotal=e;e=document.createElement("div");e.className="row2";e.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';
d.appendChild(e);c.baseElement.appendChild(d);c.musicButton=View.createWhiteButton(c.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small visible");c.musicButton.style.position="absolute";c.musicButton.style.left=extraLargeMarginCss;c.musicButton.style.bottom=extraLargeMarginCss;c.baseElement.appendChild(c.musicButton);c.alive=!0;c.animating=!1;c.frameRequest=0;c.lastTime=0;c.pointerHandler=null;c.movingAlien=null;c.movingInitialX=0;c.movingInitialY=0;c.round=0;c.points=
0;c.lastPlacedAlien=0;c.originalAlienPlacement=-1;c.boundMouseDown=c.mouseDown.bind(c);c.boundMouseMove=c.mouseMove.bind(c);c.boundMouseUp=c.mouseUp.bind(c);c.boundOutsidePointerHandler=c.outsidePointerHandler.bind(c);c.boundRender=c.render.bind(c);return c}__extends(b,a);b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){musicButton=this.musicButton;updateMusicButton();this.lastTime=performance.now();this.alive=!0;this.pointerHandler=
new PointerHandler(this.baseElement,this.boundMouseDown,this.boundMouseMove,this.boundMouseUp,!1,this.boundOutsidePointerHandler);return[2]})})};b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){musicButton=null;this.alive=!1;this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);return[2]})})};b.prototype.destroyInternal=function(c){c||
Alien.destroyAll()};b.prototype.fadeInFinished=function(){this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.frameRequest=requestAnimationFrame(this.boundRender);this.restart()};b.prototype.back=function(c){this.fadeTo(function(){return new TitleView});return!0};b.prototype.displayAddedPoints=function(c,d){return __awaiter(this,void 0,void 0,function(){var e;return __generator(this,function(g){switch(g.label){case 0:d&&1<this.round&&this.round<=b.TotalRoundCount&&
...
a.call(this)||this,d=View.createWhiteButton(c.baseElement,{imageId:Icon.Clear,text:Strings.Close},c.back.bind(c),"small");d.style.position="absolute";d.style.left=extraLargeMarginCss;d.style.top=extraLargeMarginCss;return c}__extends(b,a);b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){return[2]})})};b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){return[2]})})};b.prototype.destroyInternal=
...
function rem2Px(a){return fontSize*a+"px"}function rem2PxNumber(a){return fontSize*a}function smoothStep(a){return a*a*(3-2*a)}function delay(a){return new Promise(function(b){return window.setTimeout(b,a)})}function handleBlink(a){var b=a[0],c=a[1];0<b&&b<blinkLastCounter?(c.style.visibility=b&1?"":"hidden",a[0]=b+1):abortBlink(c)}
function abortBlink(a){if(a){var b=a.getAttribute("data-blink-interval");b&&(a.setAttribute("data-blink-interval",""),(b=parseInt(b))&&clearInterval(b),a.style.visibility="")}}function blink(a){a&&(abortBlink(a),a.style.visibility="hidden",a.setAttribute("data-blink-interval",window.setInterval(handleBlink,blinkSingleDurationMS,[1,a]).toString()))}function prepareButtonBlink(a,b,c){a.onclick=function(d){View.loading||View.fading||!b&&Modal.visible||!c(d)||blink(a)}}
function zeroObject(a){for(var b in a)switch(typeof a[b]){case "function":break;case "boolean":a[b]=!1;break;case "number":a[b]=0;break;default:var c=a[b];Array.isArray(c)&&c.fill(null);a[b]=null}}
...
void 0,void 0,function(){var b,c;return __generator(this,function(d){switch(d.label){case 0:d.trys.push([0,5,,6]);if(!("AudioContext"in window&&"AudioBuffer"in window&&"AudioBufferSourceNode"in window&&"fetch"in window))return[3,4];audioContext=new AudioContext;audioContext.suspend();c=(b=audioContext).decodeAudioData;return[4,fetch("assets/sounds/bg.mp3")];case 1:return[4,d.sent().arrayBuffer()];case 2:return[4,c.apply(b,[d.sent()])];case 3:return audioBuffer=d.sent(),[2];case 4:return[3,6];case 5:return d.sent(),
audioBuffer=audioContext=null,[3,6];case 6:return bgMusic=document.createElement("audio"),bgMusic.loop=!0,bgMusic.src="assets/sounds/bg.mp3",document.body.appendChild(bgMusic),bgMusic.load(),[2]}})})}(),Alien.preloadAllImages()]).then(a,a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
