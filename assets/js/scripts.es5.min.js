'use strict';var __awaiter=this&&this.__awaiter||function(a,c,b,d){function e(g){return g instanceof b?g:new b(function(f){f(g)})}return new (b||(b=Promise))(function(g,f){function h(m){try{k(d.next(m))}catch(n){f(n)}}function l(m){try{k(d["throw"](m))}catch(n){f(n)}}function k(m){m.done?g(m.value):e(m.value).then(h,l)}k((d=d.apply(a,c||[])).next())})},__generator=this&&this.__generator||function(a,c){function b(k){return function(m){return d([k,m])}}function d(k){if(g)throw new TypeError("Generator is already executing.");
...
h[1],h=k;else if(h&&e.label<h[2])e.label=h[2],e.ops.push(k);else{h[2]&&e.ops.pop();e.trys.pop();continue}}k=c.call(a,e)}catch(m){k=[6,m],f=0}finally{g=h=0}if(k[0]&5)throw k[1];return{value:k[0]?k[1]:void 0,done:!0}}var e={label:0,sent:function(){if(h[0]&1)throw h[1];return h[1]},trys:[],ops:[]},g,f,h,l;return l={next:b(0),"throw":b(1),"return":b(2)},"function"===typeof Symbol&&(l[Symbol.iterator]=function(){return this}),l},__extends=this&&this.__extends||function(){var a=function(c,b){a=Object.setPrototypeOf||
...
void 0,void 0,function(){var d,e,g,f,h,l,k,m,n,q;return __generator(this,function(p){switch(p.label){case 0:d=c.MaximumAlienCount;e=this.shelf;g=e.getElementsByClassName("alien");f=75;if(!g.length)return[3,2];d=0;h=[];l=[];k=g.length-1;for(m=0;0<=k;k--,m+=f)if(n=Alien.fromElement(g[k]))n.paused||(h.push(n.shrink(m)),d++),l.push(n);this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),h.push(delay(slowAnimationTimeoutMS)));return[4,Promise.all(h)];case 1:p.sent();
if(!this.alive)return[2];for(k=l.length-1;0<=k;k--)l[k].destroy();return[3,4];case 2:if(!this.resultLabel.classList.contains("visible"))return[3,4];this.resultLabel.classList.remove("visible");return[4,delay(slowAnimationTimeoutMS)];case 3:p.sent();if(!this.alive)return[2];p.label=4;case 4:this.displayAddedPoints(b,!0);q=Array(d);k=d-1;for(m=0;0<=k;k--,m+=f)n=Alien.create(Alien.KindRandom,e),q[k]=n.grow(m);for(k=c.TotalRoundCount;1<=k;k--)k>this.round?this.resultLabelMarker[k-1].classList.remove("done"):
...
Promise.all(d)];case 1:h.sent();if(!this.alive)return[2];Alien.destroyAll();this.animating=!1;this.lastPlacedAlien=this.points=this.round=0;this.originalAlienPlacement=-1;this.nextRound();return[2]}})})};c.prototype.showMessage=function(b,d){return __awaiter(this,void 0,void 0,function(){var e=this;return __generator(this,function(g){if(this.animating)return[2];this.animating=!0;return[2,new Promise(function(f){return __awaiter(e,void 0,void 0,function(){var h=this;return __generator(this,function(l){Modal.show({html:d,
...
a.call(this)||this;b.baseElement.classList.add("text-center");var d=View.createWhiteButton(b.baseElement,{imageId:Icon.Clear,text:Strings.Close},b.back.bind(b),"small");d.style.position="absolute";d.style.left=extraLargeMarginCss;d.style.top=extraLargeMarginCss;b.fadingRule=!1;b.currentRule=0;var e=document.createElement("div");e.className="rule-container";d=document.createElement("div");d.className="rule-prev fade";d.onclick=b.previousRule.bind(b);b.previousRuleButton=d;e.appendChild(d);d=document.createElement("div");
d.className="rule-image";d.style.background="none";b.ruleImageContainer=d;e.appendChild(d);var g=document.createElement("div");g.className="rule-next fade visible";g.onclick=b.nextRule.bind(b);b.nextRuleButton=g;e.appendChild(g);b.baseElement.appendChild(e);e=document.createElement("div");e.className="result-label visible";g=Array(c.TotalRuleCount);for(var f=Array(c.TotalRuleCount),h=0;h<c.TotalRuleCount;h++){var l=document.createElement("img");l.className=h?"rule-image fade":"rule-image fade visible";
l.src="assets/images/rule"+h+".png";g[h]=l;l=document.createElement("span");l.className=h?"marker":"marker done";e.appendChild(l);f[h]=l;var k=document.createElement("span");k.className="points";l.appendChild(k)}b.ruleImage=g;b.ruleMarker=f;d.appendChild(g[0]);d=document.createElement("div");d.className="row2";d.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';
e.appendChild(d);b.baseElement.appendChild(e);return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.destroyInternal=function(b){};c.prototype.back=function(b){this.fadeToPrevious();return!0};c.prototype.changeRule=function(b){return __awaiter(this,void 0,void 0,function(){var d,
e,g;return __generator(this,function(f){switch(f.label){case 0:if(View.fading||this.fadingRule||!this.ruleMarker)return[2];d=this.currentRule+b;if(0>d||d>=c.TotalRuleCount)return[2];this.fadingRule=!0;0<d?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible");d<c.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible");this.ruleImage[this.currentRule].classList.remove("visible");return[4,delay(slowAnimationTimeoutMS)];
case 1:f.sent();e=this.ruleMarker;for(g=0;g<c.TotalRuleCount;g++)g<=d?e[g].classList.add("done"):e[g].classList.remove("done");this.ruleImageContainer.removeChild(this.ruleImage[this.currentRule]);this.ruleImageContainer.appendChild(this.ruleImage[d]);return[4,delay(animationStartDelayMS)];case 2:return f.sent(),this.ruleImage[d].classList.add("visible"),this.currentRule=d,[4,delay(slowAnimationTimeoutMS)];case 3:return f.sent(),this.fadingRule=!1,[2]}})})};c.prototype.previousRule=function(){this.changeRule(-1)};
c.prototype.nextRule=function(){this.changeRule(1)};c.TotalRuleCount=5;return c}(View),TitleView=function(a){function c(){var b=a.call(this)||this;b.baseElement.innerHTML='\n\t\t<div style="margin: 2em 0;">\n\t\t\t<img id="logo" src="assets/images/logo.png" alt="Logo" class="fade" style="width: 20rem;" />\n\t\t</div>\n\t\t<div id="subtitle" class="fade" style="margin: 2em 0 1em;">\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t\t&nbsp;\n\t\t\tBLOCKCHAIN GAME\n\t\t\t&nbsp;\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t</div>\n\t\t';
