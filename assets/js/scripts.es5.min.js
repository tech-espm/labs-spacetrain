...
83886337;a.Exit=83951873;a.Menu=84017409;a.Download=84082945;a.Success=100663553;a.Error=100729089;a.Trophy=100794625;a.Clock=100860161;a.DeviceHI=100925697;a.DeviceVI=100991233;return a}(),FullscreenControl=function(){function a(){}a.requestFullscreen=function(c){c||(c=document.body);var b=!0,d=null;try{c.requestFullscreen?d=c.requestFullscreen():c.webkitRequestFullscreen?d=c.webkitRequestFullscreen():c.mozRequestFullScreen?d=c.mozRequestFullScreen():c.msRequestFullscreen?d=c.msRequestFullscreen():
b=!1}catch(e){b=!1}b||c===document.body?ignorePromise(d):a.requestFullscreen()};a.exitFullscreen=function(){var c=null;try{document.exitFullscreen?c=document.exitFullscreen():document.webkitExitFullscreen?c=document.webkitExitFullscreen():document.mozExitFullScreen?c=document.mozExitFullScreen():document.msExitFullscreen&&(c=document.msExitFullscreen())}catch(b){}ignorePromise(c)};Object.defineProperty(a,"fullscreenElement",{get:function(){var c=null;try{"fullscreenElement"in document&&(c=document.fullscreenElement),
!c&&"webkitFullscreenElement"in document&&(c=document.webkitFullscreenElement),!c&&"mozFullscreenElement"in document&&(c=document.mozFullscreenElement),!c&&"msFullscreenElement"in document&&(c=document.msFullscreenElement)}catch(b){}return c},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"onfullscreenchange",{get:function(){try{if("onfullscreenchange"in document)return document.onfullscreenchange;if("onwebkitfullscreenchange"in document)return document.onwebkitfullscreenchange;
if("onmozfullscreenchange"in document)return document.onmozfullscreenchange;if("onmsfullscreenchange"in document)return document.onmsfullscreenchange}catch(c){}return null},enumerable:!1,configurable:!0});Object.defineProperty(a,"onfullscreenchange",{set:function(c){try{"onfullscreenchange"in document&&(document.onfullscreenchange=c),"onwebkitfullscreenchange"in document&&(document.onwebkitfullscreenchange=c),"onmozfullscreenchange"in document&&(document.onmozfullscreenchange=c),"onmsfullscreenchange"in
document&&(document.onmsfullscreenchange=c)}catch(b){}},enumerable:!1,configurable:!0});a.toggleFullscreen=function(){a.fullscreenMode=!a.fullscreenMode};Object.defineProperty(a,"fullscreenMode",{get:function(){return!!a.fullscreenElement},set:function(c){c?a.requestFullscreen():a.exitFullscreen()},enumerable:!1,configurable:!0});return a}(),PointerHandler=function(){function a(c,b,d,e,g,f){void 0===b&&(b=null);void 0===d&&(d=null);void 0===e&&(e=null);void 0===g&&(g=!0);void 0===f&&(f=null);this.documentTarget=
document.documentElement||document.body;this.element=c;this.downCallback=b;this.moveCallback=d;this.upCallback=e;this.boundExtraTouchStart=null;"onpointerdown"in c?(this.documentDownEvent="pointerdown",this.documentMoveEvent="pointermove",this.documentUpEvent="pointerup",this.documentCancelEvent="pointercancel",this.boundDocumentDown=this.pointerDown.bind(this),this.boundDocumentUp=this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this),"ontouchstart"in c&&(this.boundExtraTouchStart=
...
this.modalElement.innerHTML=c.html:this.modalElement.appendChild(c.html);this.containerElement.appendChild(this.modalElement);View.main.appendChild(this.containerElement);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;window.setTimeout(function(){if(c.onshowing)c.onshowing();b.resizeInternal();b.containerElement.classList.add("visible");window.setTimeout(function(){b.fading=!1;b.containerElement.onclick=a.hide;
View.pushHistoryStateIfNecessary();if(b.options.onshown)b.options.onshown()},slowAnimationTimeoutMS)},animationStartDelayMS)}Object.defineProperty(a,"visible",{get:function(){return!!a.modal},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalElement",{get:function(){return a.modal?a.modal.modalElement:null},enumerable:!1,configurable:!0});a.show=function(c){if(a.modal)return!1;a.modal=new a(c);return!0};a.hide=function(){a.modal&&a.modal.hideInternal()};a.defaultCancelAction=function(){a.modal&&
a.modal.hideInternal()};a.windowResized=function(){a.modal&&a.modal.resizeInternal()};a.prototype.hideInternal=function(){var c=this;a.modal!==this||this.fading||this.options.onhiding&&!1===this.options.onhiding()||(document.removeEventListener("keydown",this.boundDocumentKeyDown,!0),this.fading=!0,this.containerElement.classList.remove("visible"),window.setTimeout(function(){a.modal=null;View.popHistoryStateIfNecessary();if(c.options.onhidden)c.options.onhidden();View.main.removeChild(c.containerElement);
...
"small");d.style.position="absolute";d.style.left=smallMarginCss;d.style.top=smallMarginCss;d=document.createElement("div");d.className="text-center";d.style.paddingLeft=smallMarginCss;d.style.paddingRight=smallMarginCss;d.style.paddingBottom=smallMarginCss;d.innerHTML=Strings.CreditsHTML;b.baseElement.appendChild(d);b.baseElement.style.backgroundColor="rgba(47,14,82,0.75)";return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,
function(b){return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.destroyInternal=function(b){};c.prototype.back=function(b){this.fadeToPrevious();return!0};return c}(View),GameView=function(a){function c(){var b=a.call(this)||this;b.baseElement.classList.add("text-center");var d=View.createWhiteButton(b.baseElement,{imageId:Icon.Clear,text:Strings.Close},b.back.bind(b),"small");d.style.position="absolute";
d.style.left=smallMarginCss;d.style.top=smallMarginCss;d=View.createBlueButton(b.baseElement,{imageId:Icon.Accept,text:Strings.NextRound},b.nextRound.bind(b),"small fade visible");d.setAttribute("disabled","disabled");d.style.position="absolute";d.style.right=smallMarginCss;d.style.top=smallMarginCss;b.nextRoundButton=d;d=document.createElement("div");d.style.pointerEvents="none";d.style.marginTop=alienHeightCss;d.style.height=alienHeightCss;b.shelf=d;b.baseElement.appendChild(d);d=document.createElement("div");
d.className="train";b.alienRow=d;for(var e=c.MaximumAlienCount-1;0<=e;e--){var g=document.createElement("div");g.className="target";d.appendChild(g)}b.baseElement.appendChild(d);d=document.createElement("div");d.className="result-label";b.resultLabel=d;e=document.createElement("span");e.className="round";d.appendChild(e);b.resultLabelRound=e;g=Array(c.TotalRoundCount);for(e=0;e<c.TotalRoundCount;e++){var f=document.createElement("span");f.className="marker";d.appendChild(f);g[e]=f;var h=document.createElement("span");
h.className="points";f.appendChild(h)}b.resultLabelMarker=g;e=document.createElement("span");e.className="total";d.appendChild(e);b.resultLabelTotal=e;e=document.createElement("div");e.className="row2";e.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';d.appendChild(e);b.baseElement.appendChild(d);
b.musicButton=View.createWhiteButton(b.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small visible");b.musicButton.style.position="absolute";b.musicButton.style.fontSize="0.5rem";b.musicButton.style.left="1.5rem";b.musicButton.style.bottom="1.5rem";b.baseElement.appendChild(b.musicButton);b.alive=!0;b.animating=!1;b.frameRequest=0;b.lastTime=0;b.pointerHandler=null;b.movingAlien=null;b.movingInitialX=0;b.movingInitialY=0;b.round=0;b.points=0;b.lastPlacedAlien=0;b.originalAlienPlacement=
-1;b.boundMouseDown=b.mouseDown.bind(b);b.boundMouseMove=b.mouseMove.bind(b);b.boundMouseUp=b.mouseUp.bind(b);b.boundOutsidePointerHandler=b.outsidePointerHandler.bind(b);b.boundRender=b.render.bind(b);return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){musicButton=this.musicButton;updateMusicButton();this.lastTime=performance.now();this.alive=!0;this.pointerHandler=new PointerHandler(this.baseElement,this.boundMouseDown,
this.boundMouseMove,this.boundMouseUp,!1,this.boundOutsidePointerHandler);return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){musicButton=null;this.alive=!1;this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);return[2]})})};c.prototype.destroyInternal=function(b){b||Alien.destroyAll()};c.prototype.fadeInFinished=function(){this.frameRequest&&
(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.frameRequest=requestAnimationFrame(this.boundRender);this.restart()};c.prototype.back=function(b){this.fadeTo(function(){return new TitleView});return!0};c.prototype.displayAddedPoints=function(b,d){return __awaiter(this,void 0,void 0,function(){var e;return __generator(this,function(g){switch(g.label){case 0:d&&1<this.round&&this.round<=c.TotalRoundCount&&(this.resultLabelMarker[this.round-2].firstChild.textContent=b.toString());
if(!b)return[2];e=document.createElement("div");e.className="added-points";e.textContent="+ "+b+" "+(1===b?Strings.point:Strings.points)+"!";this.baseElement.appendChild(e);return[4,delay(animationStartDelayMS)];case 1:g.sent();if(!this.alive)return[2];e.classList.add("fading");return[4,delay(1500)];case 2:g.sent();if(!this.alive)return[2];this.baseElement.removeChild(e);return[2]}})})};c.prototype.generateNewAliens=function(b){return __awaiter(this,void 0,void 0,function(){var d,e,g,f,h,m,k,l,n,
q;return __generator(this,function(p){switch(p.label){case 0:d=c.MaximumAlienCount;e=this.shelf;g=e.getElementsByClassName("alien");f=75;if(!g.length)return[3,2];d=0;h=[];m=[];k=g.length-1;for(l=0;0<=k;k--,l+=f)if(n=Alien.fromElement(g[k]))n.paused||(h.push(n.shrink(l)),d++),m.push(n);this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),h.push(delay(slowAnimationTimeoutMS)));return[4,Promise.all(h)];case 1:p.sent();if(!this.alive)return[2];for(k=m.length-1;0<=
k;k--)m[k].destroy();return[3,4];case 2:if(!this.resultLabel.classList.contains("visible"))return[3,4];this.resultLabel.classList.remove("visible");return[4,delay(slowAnimationTimeoutMS)];case 3:p.sent();if(!this.alive)return[2];p.label=4;case 4:this.displayAddedPoints(b,!0);q=Array(d);k=d-1;for(l=0;0<=k;k--,l+=f)n=Alien.create(Alien.KindRandom,e),q[k]=n.grow(l);for(k=c.TotalRoundCount;1<=k;k--)k>this.round?this.resultLabelMarker[k-1].classList.remove("done"):this.resultLabelMarker[k-1].classList.add("done"),
k>=this.round&&(this.resultLabelMarker[k-1].firstChild.textContent="");this.resultLabelRound.textContent=Strings.Round+this.round;this.resultLabelTotal.textContent=Strings.Total+this.points;return[4,delay(animationStartDelayMS)];case 5:p.sent();if(!this.alive)return[2];this.resultLabel.classList.add("visible");return[4,Promise.all(q)];case 6:p.sent();if(!this.alive)return[2];this.animating=!1;return[2]}})})};c.prototype.restart=function(){return __awaiter(this,void 0,void 0,function(){var b,d,e,g,
f;return __generator(this,function(h){switch(h.label){case 0:if(!this.alive||this.animating||this.movingAlien)return[2];this.nextRoundButton.setAttribute("disabled","disabled");this.nextRoundButton.replaceChild(document.createTextNode(Strings.NextRound),this.nextRoundButton.childNodes[1]);this.animating=!0;b=this.baseElement.getElementsByClassName("alien");d=[];e=b.length-1;for(g=0;0<=e;e--,g+=75)(f=Alien.fromElement(b[e]))&&!f.paused&&d.push(f.shrink(g));return[4,Promise.all(d)];case 1:h.sent();
if(!this.alive)return[2];Alien.destroyAll();this.animating=!1;this.lastPlacedAlien=this.points=this.round=0;this.originalAlienPlacement=-1;this.nextRound();return[2]}})})};c.prototype.showMessage=function(b,d){return __awaiter(this,void 0,void 0,function(){var e=this;return __generator(this,function(g){if(this.animating)return[2];this.animating=!0;return[2,new Promise(function(f){return __awaiter(e,void 0,void 0,function(){var h=this;return __generator(this,function(m){Modal.show({html:d,error:b,
onhidden:function(){h.alive&&(h.animating=!1,f())}});return[2]})})})]})})};c.prototype.gameOver=function(b){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(d){switch(d.label){case 0:return[4,this.showMessage(!0,b)];case 1:d.sent();if(!this.alive)return[2];this.animating=!0;return[4,delay(slowAnimationTimeoutMS)];case 2:d.sent();if(!this.alive)return[2];this.animating=!1;return[2,this.restart()]}})})};c.prototype.gameFinished=function(b,d,e){return __awaiter(this,void 0,
void 0,function(){return __generator(this,function(g){switch(g.label){case 0:return this.animating=!0,this.resultLabel.classList.remove("visible"),[4,delay(fastAnimationTimeoutMS)];case 1:g.sent();if(!this.alive)return[2];this.round++;return[4,this.displayAddedPoints(b,!1)];case 2:g.sent();if(!this.alive)return[2];this.animating=!1;return[4,this.showMessage(!1,Strings.Victory.replace("{totalPoints}",this.points.toString()).replace("{regularPoints}",(this.points-e).toString()).replace("{extraPoints}",
...
a.call(this)||this,d=View.createWhiteButton(b.baseElement,{imageId:Icon.Clear,text:Strings.Close},b.back.bind(b),"small");d.style.position="absolute";d.style.left=smallMarginCss;d.style.top=smallMarginCss;return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.destroyInternal=
function(b){};c.prototype.back=function(b){this.fadeToPrevious();return!0};return c}(View),TitleView=function(a){function c(){var b=a.call(this)||this;b.baseElement.innerHTML='\n\t\t<div style="margin: 2em 0;">\n\t\t\t<img id="logo" src="assets/images/logo.png" alt="Logo" class="fade" style="width: 20rem;" />\n\t\t</div>\n\t\t<div id="subtitle" class="fade" style="margin: 2em 0 1em;">\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t\t&nbsp;\n\t\t\tBLOCKCHAIN GAME\n\t\t\t&nbsp;\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t</div>\n\t\t';
...
b.creditsButton=View.createPinkButton(b.baseElement,Strings.CREDITS,b.credits.bind(b),"fade");b.creditsButton.style.marginBottom=largeMarginCss;b.footer=document.createElement("div");b.footer.className="green small fade";b.footer.textContent="2021 - GameLab ESPM (@gamelab_espm) + Hub Arenas ESPM (@arenas_espm) - #GoGamers";b.baseElement.appendChild(b.footer);b.musicButton=View.createWhiteButton(b.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small");b.musicButton.style.position=
"absolute";b.musicButton.style.left="1.5rem";b.musicButton.style.bottom="3rem";b.fullscreenButton=View.createWhiteButton(b.baseElement,Strings.Fullscreen,b.fullscreen.bind(b),"fade small");b.fullscreenButton.style.position="absolute";b.fullscreenButton.style.right="1.5rem";b.fullscreenButton.style.bottom="3rem";b.fadeSequence=0;b.fadeElements=null;b.fadeInterval=0;return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){musicButton=
this.musicButton;updateMusicButton();return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){musicButton=null;this.fadeInterval&&(clearInterval(this.fadeInterval),this.fadeInterval=0);return[2]})})};c.prototype.destroyInternal=function(b){};c.prototype.fadeInFinished=function(){this.startFadeSequence(1)};c.prototype.startFadeSequence=function(b,d){var e=this;if(!this.fadeSequence){var g=[this.logo,this.subtitle,this.startButton,
this.rulesButton,this.creditsButton,this.footer,this.musicButton,this.fullscreenButton];0>b&&g.reverse();this.fadeSequence=b;this.fadeElements=g;this.fadeInterval=window.setInterval(function(){var f=Math.abs(e.fadeSequence)-1;!e.fadeElements||f>=e.fadeElements.length?(clearInterval(e.fadeInterval),e.fadeSequence=0,e.fadeElements=null,e.fadeInterval=0,d&&d()):(f=e.fadeElements[f],0<e.fadeSequence?(f.classList.add("visible"),e.fadeSequence++):(f.classList.remove("visible"),e.fadeSequence--))},100)}};
c.prototype.start=function(b){var d=this;if(Modal.visible||this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new GameView})});return!0};c.prototype.rules=function(b){var d=this;if(this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new RulesView},!0)});return!0};c.prototype.credits=function(b){var d=this;if(this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new CreditsView},
!0)});return!0};c.prototype.fullscreen=function(b){FullscreenControl.toggleFullscreen();return!0};return c}(View),scaleFactor=-1,widthCss=0,heightCss=0,baseLeftCss=0,baseTopCss=0,fontSize=0,fontSizeCss="0px",musicPlaying=!0,bgMusic=document.getElementById("bg-music"),musicButton=null,installationPrompt=null,landscapeWarning=null;function ignorePromise(a){try{var c=function(){};a&&a.then&&a.then(c,c)}catch(b){}}
function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),"preventDefault"in a&&a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}function format2(a){return 10>a?"0"+a:a.toString()}function rem2Px(a){return fontSize*a+"px"}function rem2PxNumber(a){return fontSize*a}function smoothStep(a){return a*a*(3-2*a)}function delay(a){return new Promise(function(c){return window.setTimeout(c,a)})}
function handleBlink(a){var c=a[0],b=a[1];0<c&&c<blinkLastCounter?(b.style.visibility=c&1?"":"hidden",a[0]=c+1):abortBlink(b)}function abortBlink(a){if(a){var c=a.getAttribute("data-blink-interval");c&&(a.setAttribute("data-blink-interval",""),(c=parseInt(c))&&clearInterval(c),a.style.visibility="")}}function blink(a){a&&(abortBlink(a),a.style.visibility="hidden",a.setAttribute("data-blink-interval",window.setInterval(handleBlink,blinkSingleDurationMS,[1,a]).toString()))}
function prepareButtonBlink(a,c,b){a.onclick=function(d){View.loading||View.fading||!c&&Modal.visible||!b(d)||blink(a)}}function zeroObject(a){for(var c in a)switch(typeof a[c]){case "function":break;case "boolean":a[c]=!1;break;case "number":a[c]=0;break;default:var b=a[c];Array.isArray(b)&&b.fill(null);a[c]=null}}
...
landscapeWarning&&(document.body.removeChild(landscapeWarning),landscapeWarning=null);View.main.style.width=c+"px";View.main.style.height=b+"px";scaleFactor!==a?(fontSize=b/baseHeightFontUnits|0,fontSizeCss=fontSize+"px",document.documentElement&&(document.documentElement.style.fontSize=fontSizeCss),document.body.style.fontSize=fontSizeCss,View.windowResized(!0)):View.windowResized(!1);Modal.windowResized()}
...
var fullscreenChangedTimeout=0;function fullscreenChanged(a){fullscreenChangedTimeout&&(clearTimeout(fullscreenChangedTimeout),fullscreenChangedTimeout=0);try{FullscreenControl.fullscreenMode?fullscreenChangedTimeout=setTimeout(fullscreenChangedHandler,150):fullscreenChangedHandler()}catch(c){}}
