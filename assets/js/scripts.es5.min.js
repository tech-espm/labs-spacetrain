...
d.style.pointerEvents="none";d.style.marginTop=alienHeightRem+extraLargeMarginRem+"rem";d.style.height=alienHeightCss;b.shelf=d;b.baseElement.appendChild(d);var e=document.createElement("div");e.className="train";b.alienRow=e;var g=Array(c.MaximumAlienCount);b.targets=g;b.lastHoverTarget=-1;for(d=0;d<g.length;d++){var f=document.createElement("div");f.className="target";g[d]=f;e.appendChild(f)}b.baseElement.appendChild(e);e=document.createElement("div");e.className="result-label";b.resultLabel=e;
d=document.createElement("span");d.className="round";e.appendChild(d);b.resultLabelRound=d;g=Array(c.TotalRoundCount);for(d=0;d<c.TotalRoundCount;d++){f=document.createElement("span");f.className="marker";e.appendChild(f);g[d]=f;var h=document.createElement("span");h.className="points";f.appendChild(h)}b.resultLabelMarker=g;d=document.createElement("span");d.className="total";e.appendChild(d);b.resultLabelTotal=d;d=document.createElement("div");d.className="row2";d.innerHTML='<s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s><img src="assets/images/logo-small.png" /><s>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</s>';
e.appendChild(d);b.baseElement.appendChild(e);b.musicButton=View.createWhiteButton(b.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small visible");b.musicButton.style.position="absolute";b.musicButton.style.left=extraLargeMarginCss;b.musicButton.style.bottom=extraLargeMarginCss;b.baseElement.appendChild(b.musicButton);b.alive=!0;b.animating=!1;b.frameRequest=0;b.lastTime=0;b.pointerHandler=null;b.movingAlien=null;b.movingInitialX=0;b.movingInitialY=0;b.round=0;b.points=
...
this.points+=d;this.gameFinished(b+d,e,d);return!0}this.animating=!0;this.round++;this.nextRoundButton.setAttribute("disabled","disabled");this.generateNewAliens(b);return!0};c.prototype.getTarget=function(b,d){var e=this.alienRow.getBoundingClientRect();if(d>=e.top&&d<e.bottom){d=this.targets;for(var g=d.length-1;0<=g;g--)if(!(b<(e=d[g].getBoundingClientRect()).left||b>=e.right))return g}return-1};c.prototype.mouseDown=function(b){if(!this.alive||this.animating)return!1;var d=b.clientX;b=b.clientY;
for(var e=[this.shelf,this.alienRow],g=e.length-1;0<=g;g--){var f=e[g].getElementsByClassName("alien"),h=e[g].getBoundingClientRect();if(b>=h.top&&b<h.bottom&&f&&f.length)for(var m=f.length-1;0<=m;m--)if(h=f[m].getBoundingClientRect(),d>=h.left&&d<h.right&&(h=Alien.fromElement(f[m]))&&h.element&&!h.paused)return h.element.classList.add("moving"),this.movingInitialX=d,this.movingInitialY=b,this.movingAlien=h,this.originalAlienPlacement=h.placement,0<=this.lastHoverTarget&&(this.targets[this.lastHoverTarget].classList.remove("hover"),
this.lastHoverTarget=-1),1===g&&(this.lastHoverTarget=this.getTarget(d,b),0<=this.lastHoverTarget&&this.targets[this.lastHoverTarget].classList.add("hover")),!0}return!1};c.prototype.mouseMove=function(b){var d=this.movingAlien;if(d&&d.element){var e=b.clientX;b=b.clientY;d.element.style.transform="translate("+(e-this.movingInitialX)+"px, "+(b-this.movingInitialY)+"px)";d=this.getTarget(e,b);d!==this.lastHoverTarget&&(e=this.targets,0<=this.lastHoverTarget&&e[this.lastHoverTarget].classList.remove("hover"),
0<=d&&e[d].classList.add("hover"),this.lastHoverTarget=d)}};c.prototype.mouseUp=function(b){var d=this.targets;0<=this.lastHoverTarget&&(d[this.lastHoverTarget].classList.remove("hover"),this.lastHoverTarget=-1);var e=this.movingAlien;e&&e.element&&(this.movingAlien=null,b=this.getTarget(b.clientX,b.clientY),e.element.classList.remove("moving"),e.element.style.transform="",0>b||(0<=this.originalAlienPlacement?this.originalAlienPlacement!==b&&this.gameOver(Strings.GameOverReposition):d[b].childNodes.length?
this.gameOver(Strings.GameOverReplace):this.lastPlacedAlien!==b?this.gameOver(Strings.GameOverFirstAvailable):(e.paused=!0,e.element.style.visibility="hidden",Alien.create(e.kind,d[b],this.lastPlacedAlien).grow(),this.lastPlacedAlien++,this.round<c.TotalRoundCount&&this.nextRoundButton.removeAttribute("disabled"),this.lastPlacedAlien>=c.MaximumAlienCount&&(this.nextRoundButton.removeAttribute("disabled"),this.nextRoundButton.replaceChild(document.createTextNode(Strings.Finish),this.nextRoundButton.childNodes[1])))))};
c.prototype.outsidePointerHandler=function(b){return b.target&&"target"===b.target.className&&b.target.childNodes.length?!0:!1};c.prototype.render=function(b){if(this.alive){this.frameRequest=requestAnimationFrame(this.boundRender);var d=b-this.lastTime;this.lastTime=b;33<d&&(d=33);Alien.stepAll(d)}else this.frameRequest=0};c.TotalRoundCount=5;c.MaximumAlienCount=8;c.PointsPerSequence=[0,1,3,6,10,15,21,28,36];return c}(View),RulesView=function(a){function c(){var b=a.call(this)||this;b.baseElement.classList.add("text-center");
var d=View.createWhiteButton(b.baseElement,{imageId:Icon.Clear,text:Strings.Close},b.back.bind(b),"small");d.style.position="absolute";d.style.left=extraLargeMarginCss;d.style.top=extraLargeMarginCss;b.fadingRule=!1;b.currentRule=0;var e=document.createElement("div");e.className="rule-container";d=document.createElement("div");d.className="rule-prev fade";d.onclick=b.previousRule.bind(b);b.previousRuleButton=d;e.appendChild(d);d=document.createElement("div");d.className="rule-image";d.style.background=
"none";b.ruleImageContainer=d;e.appendChild(d);var g=document.createElement("div");g.className="rule-next fade visible";g.onclick=b.nextRule.bind(b);b.nextRuleButton=g;e.appendChild(g);b.baseElement.appendChild(e);e=Array(c.TotalRuleCount);for(g=0;g<c.TotalRuleCount;g++){var f=document.createElement("img");f.className=g?"rule-image fade":"rule-image fade visible";f.src="assets/images/rule"+g+".png";e[g]=f}b.ruleImage=e;d.appendChild(e[0]);return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,
void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){return[2]})})};c.prototype.destroyInternal=function(b){};c.prototype.back=function(b){this.fadeToPrevious();return!0};c.prototype.changeRule=function(b){return __awaiter(this,void 0,void 0,function(){var d;return __generator(this,function(e){switch(e.label){case 0:if(View.fading||this.fadingRule||!this.ruleImage)return[2];
d=this.currentRule+b;if(0>d||d>=c.TotalRuleCount)return[2];this.fadingRule=!0;0<d?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible");d<c.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible");this.ruleImage[this.currentRule].classList.remove("visible");return[4,delay(slowAnimationTimeoutMS)];case 1:return e.sent(),this.ruleImageContainer.removeChild(this.ruleImage[this.currentRule]),this.ruleImageContainer.appendChild(this.ruleImage[d]),
[4,delay(animationStartDelayMS)];case 2:return e.sent(),this.ruleImage[d].classList.add("visible"),this.currentRule=d,[4,delay(slowAnimationTimeoutMS)];case 3:return e.sent(),this.fadingRule=!1,[2]}})})};c.prototype.previousRule=function(){this.changeRule(-1)};c.prototype.nextRule=function(){this.changeRule(1)};c.TotalRuleCount=5;return c}(View),TitleView=function(a){function c(){var b=a.call(this)||this;b.baseElement.innerHTML='\n\t\t<div style="margin: 2em 0;">\n\t\t\t<img id="logo" src="assets/images/logo.png" alt="Logo" class="fade" style="width: 20rem;" />\n\t\t</div>\n\t\t<div id="subtitle" class="fade" style="margin: 2em 0 1em;">\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t\t&nbsp;\n\t\t\tBLOCKCHAIN GAME\n\t\t\t&nbsp;\n\t\t\t<s>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</s>\n\t\t</div>\n\t\t';
...
b.creditsButton=View.createPinkButton(b.baseElement,Strings.CREDITS,b.credits.bind(b),"fade");b.creditsButton.style.marginBottom=largeMarginCss;b.musicButton=View.createWhiteButton(b.baseElement,musicPlaying?Strings.StopMusic:Strings.PlayMusic,toggleMusic,"fade small");b.musicButton.style.position="absolute";b.musicButton.style.left=extraLargeMarginCss;b.musicButton.style.bottom=extraLargeMarginCss;b.installButton=View.createBlueButton(b.baseElement,Strings.Install,b.install.bind(b),"fade small");
b.installButton.style.position="absolute";b.installButton.style.right=extraLargeMarginCss;b.installButton.style.bottom=extraLargeMarginRem+2+"rem";b.fullscreenButton=View.createWhiteButton(b.baseElement,Strings.Fullscreen,b.fullscreen.bind(b),"fade small");b.fullscreenButton.style.position="absolute";b.fullscreenButton.style.right=extraLargeMarginCss;b.fullscreenButton.style.bottom=extraLargeMarginCss;b.fadeSequence=0;b.fadeElements=null;b.fadeInterval=0;b.boundInstallationPromptHandler=b.installationPromptHandler.bind(b);
b.installationPromptHandler();return b}__extends(c,a);c.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){installationPromptHandler=this.boundInstallationPromptHandler;musicButton=this.musicButton;updateMusicButton();return[2]})})};c.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){musicButton=installationPromptHandler=null;this.fadeInterval&&(clearInterval(this.fadeInterval),
this.fadeInterval=0);return[2]})})};c.prototype.destroyInternal=function(b){};c.prototype.fadeInFinished=function(){this.startFadeSequence(1)};c.prototype.startFadeSequence=function(b,d){var e=this;if(!this.fadeSequence){var g=[this.logo,this.subtitle,this.startButton,this.rulesButton,this.creditsButton,this.musicButton,this.installButton,this.fullscreenButton];0>b&&g.reverse();this.fadeSequence=b;this.fadeElements=g;this.fadeInterval=window.setInterval(function(){var f=Math.abs(e.fadeSequence)-1;
!e.fadeElements||f>=e.fadeElements.length?(clearInterval(e.fadeInterval),e.fadeSequence=0,e.fadeElements=null,e.fadeInterval=0,d&&d()):(f=e.fadeElements[f],0<e.fadeSequence?(f.classList.add("visible"),e.fadeSequence++):(f.classList.remove("visible"),e.fadeSequence--))},100)}};c.prototype.start=function(b){var d=this;if(Modal.visible||this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new GameView})});return!0};c.prototype.rules=function(b){var d=this;
if(this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new RulesView},!0)});return!0};c.prototype.credits=function(b){var d=this;if(this.fadeSequence)return!1;this.startFadeSequence(-1,function(){return d.fadeTo(function(){return new CreditsView},!0)});return!0};c.prototype.fullscreen=function(b){FullscreenControl.toggleFullscreen();return!0};c.prototype.install=function(b){if(installationPrompt&&installationPrompt.prompt){try{b=installationPrompt,installationPrompt=
null,b.prompt()}catch(d){}setTimeout(this.boundInstallationPromptHandler,blinkTotalDurationMS)}return!0};c.prototype.installationPromptHandler=function(){this.installButton&&(this.installButton.style.display=installationPrompt?"":"none")};return c}(View),scaleFactor=-1,widthCss=0,heightCss=0,baseLeftCss=0,baseTopCss=0,fontSize=0,fontSizeCss="0px",musicPlaying=!1,audioContext=null,audioBuffer=null,audioBufferSource=null,bgMusic=null,musicButton=null,installationPrompt=null,installationPromptHandler=
null,landscapeWarning=null;function ignorePromise(a){try{var c=function(){};a&&a.then&&a.then(c,c)}catch(b){}}function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),"preventDefault"in a&&a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}function format2(a){return 10>a?"0"+a:a.toString()}function rem2Px(a){return fontSize*a+"px"}function rem2PxNumber(a){return fontSize*a}function smoothStep(a){return a*a*(3-2*a)}
function delay(a){return new Promise(function(c){return window.setTimeout(c,a)})}function handleBlink(a){var c=a[0],b=a[1];0<c&&c<blinkLastCounter?(b.style.visibility=c&1?"":"hidden",a[0]=c+1):abortBlink(b)}function abortBlink(a){if(a){var c=a.getAttribute("data-blink-interval");c&&(a.setAttribute("data-blink-interval",""),(c=parseInt(c))&&clearInterval(c),a.style.visibility="")}}
function blink(a){a&&(abortBlink(a),a.style.visibility="hidden",a.setAttribute("data-blink-interval",window.setInterval(handleBlink,blinkSingleDurationMS,[1,a]).toString()))}function prepareButtonBlink(a,c,b){a.onclick=function(d){View.loading||View.fading||!c&&Modal.visible||!b(d)||blink(a)}}function zeroObject(a){for(var c in a)switch(typeof a[c]){case "function":break;case "boolean":a[c]=!1;break;case "number":a[c]=0;break;default:var b=a[c];Array.isArray(b)&&b.fill(null);a[c]=null}}
...
fullscreenChanged;Promise.all([function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){bgMusic=document.createElement("audio");bgMusic.loop=!0;bgMusic.src="assets/sounds/bgfade.mp3";document.body.appendChild(bgMusic);bgMusic.load();return[2]})})}(),Alien.preloadAllImages()]).then(a,a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
