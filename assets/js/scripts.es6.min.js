...
class RulesView extends View{constructor(){super();const a=View.createWhiteButton(this.baseElement,{imageId:Icon.Clear,text:Strings.Close},this.back.bind(this),"small");a.style.position="absolute";a.style.left=extraLargeMarginCss;a.style.top=extraLargeMarginCss}attach(){return __awaiter(this,void 0,void 0,function*(){})}detach(){return __awaiter(this,void 0,void 0,function*(){})}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
...
this.fullscreenButton=View.createWhiteButton(this.baseElement,Strings.Fullscreen,this.fullscreen.bind(this),"fade small");this.fullscreenButton.style.position="absolute";this.fullscreenButton.style.right=extraLargeMarginCss;this.fullscreenButton.style.bottom=extraLargeMarginCss;this.fadeSequence=0;this.fadeElements=null;this.fadeInterval=0}attach(){return __awaiter(this,void 0,void 0,function*(){musicButton=this.musicButton;updateMusicButton()})}detach(){return __awaiter(this,void 0,void 0,function*(){musicButton=
null;this.fadeInterval&&(clearInterval(this.fadeInterval),this.fadeInterval=0)})}destroyInternal(a){}fadeInFinished(){this.startFadeSequence(1)}startFadeSequence(a,b){if(!this.fadeSequence){var c=[this.logo,this.subtitle,this.startButton,this.rulesButton,this.creditsButton,this.musicButton,this.fullscreenButton];0>a&&c.reverse();this.fadeSequence=a;this.fadeElements=c;this.fadeInterval=window.setInterval(()=>{var d=Math.abs(this.fadeSequence)-1;!this.fadeElements||d>=this.fadeElements.length?(clearInterval(this.fadeInterval),
...
void 0,void 0,function*(){try{if("AudioContext"in window&&"AudioBuffer"in window&&"AudioBufferSourceNode"in window&&"fetch"in window){audioContext=new AudioContext;audioContext.suspend();audioBuffer=yield audioContext.decodeAudioData(yield(yield fetch("assets/sounds/bg.mp3")).arrayBuffer());return}}catch(b){audioBuffer=audioContext=null}bgMusic=document.createElement("audio");bgMusic.loop=!0;bgMusic.src="assets/sounds/bg.mp3";document.body.appendChild(bgMusic);bgMusic.load()})}(),Alien.preloadAllImages()]).then(a,
a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
