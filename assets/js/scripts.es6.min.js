...
Strings.StopMusic="Stop music";Strings.Fullscreen="Fullscreen";Strings.START="START";Strings.RULES="RULES";Strings.CREDITS="CREDITS";Strings.DecimalSeparator=".";Strings.OppositeDecimalSeparator=",";Strings.Success="Success!";Strings.Pause="Pause";Strings.Restart="Restart";Strings.Time="Time";Strings.Name="Name";
...
GameView.PointsPerSequence=[0,1,3,6,10,15,21,28,36];class RulesView extends View{constructor(){super();const a=View.createWhiteButton(this.baseElement,{imageId:Icon.Back,text:Strings.Close},this.back.bind(this));a.style.position="absolute";a.style.left=smallMarginCss;a.style.top=smallMarginCss}attach(){return __awaiter(this,void 0,void 0,function*(){})}detach(){return __awaiter(this,void 0,void 0,function*(){})}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
...
0}attach(){return __awaiter(this,void 0,void 0,function*(){musicButton=this.musicButton;updateMusicButton()})}detach(){return __awaiter(this,void 0,void 0,function*(){musicButton=null;this.fadeInterval&&(clearInterval(this.fadeInterval),this.fadeInterval=0)})}destroyInternal(a){}fadeInFinished(){this.startFadeSequence(1)}startFadeSequence(a,b){if(!this.fadeSequence){var c=[this.logo,this.subtitle,this.startButton,this.rulesButton,this.creditsButton,this.footer,this.musicButton,this.fullscreenButton];
0>a&&c.reverse();this.fadeSequence=a;this.fadeElements=c;this.fadeInterval=window.setInterval(()=>{var d=Math.abs(this.fadeSequence)-1;!this.fadeElements||d>=this.fadeElements.length?(clearInterval(this.fadeInterval),this.fadeSequence=0,this.fadeElements=null,this.fadeInterval=0,b&&b()):(d=this.fadeElements[d],0<this.fadeSequence?(d.classList.add("visible"),this.fadeSequence++):(d.classList.remove("visible"),this.fadeSequence--))},100)}}start(a){if(Modal.visible||this.fadeSequence)return!1;this.startFadeSequence(-1,
()=>this.fadeTo(()=>new GameView));return!0}rules(a){if(this.fadeSequence)return!1;this.startFadeSequence(-1,()=>this.fadeTo(()=>new RulesView,!0));return!0}credits(a){if(this.fadeSequence)return!1;this.startFadeSequence(-1,()=>this.fadeTo(()=>new CreditsView,!0));return!0}fullscreen(a){FullscreenControl.toggleFullscreen();return!0}}
...
function format2(a){return 10>a?"0"+a:a.toString()}function rem2Px(a){return fontSize*a+"px"}function rem2PxNumber(a){return fontSize*a}function smoothStep(a){return a*a*(3-2*a)}function delay(a){return new Promise(b=>window.setTimeout(b,a))}function handleBlink(a){const b=a[0],c=a[1];0<b&&b<blinkLastCounter?(c.style.visibility=b&1?"":"hidden",a[0]=b+1):abortBlink(c)}
function abortBlink(a){if(a){var b=a.getAttribute("data-blink-interval");b&&(a.setAttribute("data-blink-interval",""),(b=parseInt(b))&&clearInterval(b),a.style.visibility="")}}function blink(a){a&&(abortBlink(a),a.style.visibility="hidden",a.setAttribute("data-blink-interval",window.setInterval(handleBlink,blinkSingleDurationMS,[1,a]).toString()))}function prepareButtonBlink(a,b,c){a.onclick=d=>{View.loading||View.fading||!b&&Modal.visible||!c(d)||blink(a)}}
