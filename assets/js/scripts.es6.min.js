...
a.appendChild(b);this.baseElement.appendChild(a)}attach(){return __awaiter(this,void 0,void 0,function*(){})}detach(){return __awaiter(this,void 0,void 0,function*(){})}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}changeRule(a){return __awaiter(this,void 0,void 0,function*(){if(!View.fading&&!this.fadingRule&&this.ruleMarker){var b=this.currentRule+a;if(!(0>b||b>=RulesView.TotalRuleCount)){this.fadingRule=!0;0<b?this.previousRuleButton.classList.add("visible"):this.previousRuleButton.classList.remove("visible");
b<RulesView.TotalRuleCount-1?this.nextRuleButton.classList.add("visible"):this.nextRuleButton.classList.remove("visible");this.ruleImage.classList.remove("visible");yield delay(slowAnimationTimeoutMS);var c=this.ruleMarker;for(let d=0;d<RulesView.TotalRuleCount;d++)d<=b?c[d].classList.add("done"):c[d].classList.remove("done");this.ruleImage.src=`assets/images/rule${b}.png`;this.ruleImage.classList.add("visible");this.currentRule=b;yield delay(slowAnimationTimeoutMS);this.fadingRule=!1}}})}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}
...
void 0,void 0,function*(){bgMusic=document.createElement("audio");bgMusic.loop=!0;bgMusic.src="assets/sounds/bgfade.mp3";document.body.appendChild(bgMusic);bgMusic.load()})}(),Alien.preloadAllImages()]).then(a,a)}window.spacetrainStepMAIN=!0;window.spacetrainCheckSetup&&window.spacetrainCheckSetup();
