...
{document.body.appendChild(View.cover);window.setTimeout(()=>{View.cover.classList.add("visible");window.setTimeout(()=>__awaiter(this,void 0,void 0,function*(){yield this.destroy(a);a&&View.viewStack.push(this);View.currentView=null;View._fading=!1;View.pushHistoryStateIfNecessary();b()}),slowAnimationTimeoutMS)},animationStartDelayMS)})}fadeTo(a,b=!1){return View._fading||View.currentView!==this?null:(b=this.fadeOut(b))?b.then(()=>{const c=a().fadeIn();if(c)return c}):null}fadeToPrevious(){if(View._fading||
View.currentView!==this||!View.viewStack.length)return null;const a=this.fadeOut(!1);return a?a.then(()=>{const b=View.viewStack.pop().fadeIn();if(b)return b}):null}}View.main=document.getElementById("main");View.cover=document.getElementById("cover");View.fadeLeft=document.getElementById("fadeLeft");View.fadeRight=document.getElementById("fadeRight");View._loading=!1;View._fading=!1;View.mainLandscape=!1;View.currentView=null;View.viewStack=[];View.divLoading=null;View.divLoadingTimeout=0;
View.windowHistoryStatePushed=!1;class CreditsView extends View{constructor(){super();const a=View.createWhiteButton(this.baseElement,{imageId:Icon.Back,text:Strings.Close},this.back.bind(this));a.style.position="absolute";a.style.left=smallMarginCss;a.style.top=smallMarginCss}attach(){return __awaiter(this,void 0,void 0,function*(){})}detach(){return __awaiter(this,void 0,void 0,function*(){})}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
...
this.boundMouseMove=this.mouseMove.bind(this);this.boundMouseUp=this.mouseUp.bind(this);this.boundOutsidePointerHandler=this.outsidePointerHandler.bind(this);this.boundRender=this.render.bind(this)}attach(){return __awaiter(this,void 0,void 0,function*(){this.lastTime=performance.now();this.alive=!0;this.pointerHandler=new PointerHandler(this.baseElement,this.boundMouseDown,this.boundMouseMove,this.boundMouseUp,!1,this.boundOutsidePointerHandler)})}detach(){return __awaiter(this,void 0,void 0,function*(){this.alive=
!1;this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0)})}destroyInternal(a){a||Alien.destroyAll()}fadeInFinished(){this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.frameRequest=requestAnimationFrame(this.boundRender);this.restart()}back(a){this.fadeTo(()=>new TitleView);return!0}displayAddedPoints(a){return __awaiter(this,void 0,void 0,function*(){if(a){var b=
document.createElement("div");b.className="added-points";b.textContent=`+ ${a} ${Strings.points}!`;this.baseElement.appendChild(b);yield delay(animationStartDelayMS);this.alive&&(b.classList.add("fading"),yield delay(1500),this.alive&&this.baseElement.removeChild(b))}})}generateNewAliens(a){return __awaiter(this,void 0,void 0,function*(){var b=GameView.MaximumAlienCount;const c=this.shelf;var d=c.getElementsByClassName("alien");if(d.length){b=0;const f=[];var e=[];for(let g=d.length-1,l=0;0<=g;g--,
l+=75){const k=Alien.fromElement(d[g]);k&&(k.paused||(f.push(k.shrink(l)),b++),e.push(k))}this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),f.push(delay(slowAnimationTimeoutMS)));yield Promise.all(f);if(!this.alive)return;for(d=e.length-1;0<=d;d--)e[d].destroy()}else if(this.resultLabel.classList.contains("visible")&&(this.resultLabel.classList.remove("visible"),yield delay(slowAnimationTimeoutMS),!this.alive))return;this.displayAddedPoints(a);e=Array(b);
for(let f=b-1,g=0;0<=f;f--,g+=75)b=Alien.create(Alien.KindRandom,c),e[f]=b.grow(g);this.resultLabel.innerHTML=`
