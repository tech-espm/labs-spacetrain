...
this.ruleImage[b].classList.add("visible");this.currentRule=b;yield delay(slowAnimationTimeoutMS);this.fadingRule=!1}}})}previousRule(){this.changeRule(-1)}nextRule(){this.changeRule(1)}}RulesView.TotalRuleCount=5;
