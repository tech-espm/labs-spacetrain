...
"rgba(47,14,82,0.75)"}attach(){return __awaiter(this,void 0,void 0,function*(){})}detach(){return __awaiter(this,void 0,void 0,function*(){})}destroyInternal(a){}back(a){this.fadeToPrevious();return!0}}
...
`translate(${a.clientX-this.movingInitialX}px, ${a.clientY-this.movingInitialY}px)`)}mouseUp(a){const b=this.movingAlien;if(b&&b.element){this.movingAlien=null;var c=this.alienRow,d=c.children,e=a.clientX;a=a.clientY;c.classList.remove("dragging");b.element.classList.remove("moving");b.element.style.transform="";c=c.getBoundingClientRect();if(a>=c.top&&a<c.bottom)for(a=d.length-1;0<=a;a--){const f=d[a];if(!(!f.classList.contains("target")||e<(c=f.getBoundingClientRect()).left||e>=c.right)){if(0<=
